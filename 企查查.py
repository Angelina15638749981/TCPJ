...
async def main(username, pwd, url):
    ...
    chinaCompany = "贵州电网有限责任公司"
    await page.type('.index-searchkey form-control input-lg', chinaCompany, {'delay': input_time_random()})
    time.sleep(30)
    ...
    # }
    # 7b060cdc15597996975797791ee016c0e1ca8b296c4e41a3d14e096700
    # url = "https://www.qichacha.com/firm_7c2072f16a11da0d9a18a126509190b0.html"
